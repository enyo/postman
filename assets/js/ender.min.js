...
/*!
    ...
    * license MIT
    */
;!function(name,definition){typeof module!="undefined"?module.exports=definition():typeof define=="function"&&define.amd?define(name,definition):this[name]=definition()}("reqwest",function(){function handleReadyState(o,success,error){return function(){o&&o[readyState]==4&&(twoHundo.test(o.status)?success(o):error(o))}}function setHeaders(http,o){var headers=o.headers||{},h;headers.Accept=headers.Accept||defaultHeaders.accept[o.type]||defaultHeaders.accept["*"];!o.crossOrigin&&!headers[requestedWith]&&(headers[requestedWith]=defaultHeaders.requestedWith);headers[contentType]||(headers[contentType]=o.contentType||defaultHeaders.contentType);for(h in headers)headers.hasOwnProperty(h)&&http.setRequestHeader(h,headers[h])}function generalCallback(data){lastValue=data}function urlappend(url,s){return url+(/\?/.test(url)?"&":"?")+s}function handleJsonp(o,fn,err,url){var reqId=uniqid++,cbkey=o.jsonpCallback||"callback",cbval=o.jsonpCallbackName||"reqwest_"+reqId,cbreg=new RegExp("((^|\\?|&)"+cbkey+")=([^&]+)"),match=url.match(cbreg),script=doc.createElement("script"),loaded=0;match?match[3]==="?"?url=url.replace(cbreg,"$1="+cbval):cbval=match[3]:url=urlappend(url,cbkey+"="+cbval);win[cbval]=generalCallback;script.type="text/javascript";script.src=url;script.async=!0;if(typeof script.onreadystatechange!="undefined"){script.event="onclick";script.htmlFor=script.id="_reqwest_"+reqId}script.onload=script.onreadystatechange=function(){if(script[readyState]&&script[readyState]!=="complete"&&script[readyState]!=="loaded"||loaded)return!1;script.onload=script.onreadystatechange=null;script.onclick&&script.onclick();o.success&&o.success(lastValue);lastValue=undefined;head.removeChild(script);loaded=1};head.appendChild(script)}function getRequest(o,fn,err){var method=(o.method||"GET").toUpperCase(),url=typeof o=="string"?o:o.url,data=o.processData!==!1&&o.data&&typeof o.data!="string"?reqwest.toQueryString(o.data):o.data||null,http;if((o.type=="jsonp"||method=="GET")&&data){url=urlappend(url,data);data=null}if(o.type=="jsonp")return handleJsonp(o,fn,err,url);http=xhr();http.open(method,url,!0);setHeaders(http,o);http.onreadystatechange=handleReadyState(http,fn,err);o.before&&o.before(http);http.send(data);return http}function Reqwest(o,fn){this.o=o;this.fn=fn;init.apply(this,arguments)}function setType(url){var m=url.match(/\.(json|jsonp|html|xml)(\?|$)/);return m?m[1]:"js"}function init(o,fn){function complete(resp){o.timeout&&clearTimeout(self.timeout);self.timeout=null;o.complete&&o.complete(resp)}function success(resp){var r=resp.responseText;if(r)switch(type){case"json":try{resp=win.JSON?win.JSON.parse(r):eval("("+r+")")}catch(err){return error(resp,"Could not parse JSON in response",err)}break;case"js":resp=eval(r);break;case"html":resp=r}fn(resp);o.success&&o.success(resp);complete(resp)}function error(resp,msg,t){o.error&&o.error(resp,msg,t);complete(resp)}this.url=typeof o=="string"?o:o.url;this.timeout=null;var type=o.type||setType(this.url),self=this;fn=fn||function(){};o.timeout&&(this.timeout=setTimeout(function(){self.abort()},o.timeout));this.request=getRequest(o,success,error)}function reqwest(o,fn){return new Reqwest(o,fn)}function normalize(s){return s?s.replace(/\r?\n/g,"\r\n"):""}function serial(el,cb){var n=el.name,t=el.tagName.toLowerCase(),optCb=function(o){o&&!o.disabled&&cb(n,normalize(o.attributes.value&&o.attributes.value.specified?o.value:o.text))};if(el.disabled||!n)return;switch(t){case"input":if(!/reset|button|image|file/i.test(el.type)){var ch=/checkbox/i.test(el.type),ra=/radio/i.test(el.type),val=el.value;(!ch&&!ra||el.checked)&&cb(n,normalize(ch&&val===""?"on":val))}break;case"textarea":cb(n,normalize(el.value));break;case"select":if(el.type.toLowerCase()==="select-one")optCb(el.selectedIndex>=0?el.options[el.selectedIndex]:null);else for(var i=0;el.length&&i<el.length;i++)el.options[i].selected&&optCb(el.options[i])}}function eachFormElement(){var cb=this,e,i,j,serializeSubtags=function(e,tags){for(var i=0;i<tags.length;i++){var fa=e[byTag](tags[i]);for(j=0;j<fa.length;j++)serial(fa[j],cb)}};for(i=0;i<arguments.length;i++){e=arguments[i];/input|select|textarea/i.test(e.tagName)&&serial(e,cb);serializeSubtags(e,["input","select","textarea"])}}function serializeQueryString(){return reqwest.toQueryString(reqwest.serializeArray.apply(null,arguments))}function serializeHash(){var hash={};eachFormElement.apply(function(name,value){if(name in hash){hash[name]&&!isArray(hash[name])&&(hash[name]=[hash[name]]);hash[name].push(value)}else hash[name]=value},arguments);return hash}var win=window,doc=document,twoHundo=/^20\d$/,byTag="getElementsByTagName",readyState="readyState",contentType="Content-Type",requestedWith="X-Requested-With",head=doc[byTag]("head")[0],uniqid=0,lastValue,xmlHttpRequest="XMLHttpRequest",isArray=typeof Array.isArray=="function"?Array.isArray:function(a){return a instanceof Array},defaultHeaders={contentType:"application/x-www-form-urlencoded",accept:{"*":"text/javascript, text/html, application/xml, text/xml, */*",xml:"application/xml, text/xml",html:"text/html",text:"text/plain",json:"application/json, text/javascript",js:"application/javascript, text/javascript"},requestedWith:xmlHttpRequest},xhr=win[xmlHttpRequest]?function(){return new XMLHttpRequest}:function(){return new ActiveXObject("Microsoft.XMLHTTP")};Reqwest.prototype={abort:function(){this.request.abort()},retry:function(){init.call(this,this.o,this.fn)}};reqwest.serializeArray=function(){var arr=[];eachFormElement.apply(function(name,value){arr.push({name:name,value:value})},arguments);return arr};reqwest.serialize=function(){if(arguments.length===0)return"";var opt,fn,args=Array.prototype.slice.call(arguments,0);opt=args.pop();opt&&opt.nodeType&&args.push(opt)&&(opt=null);opt&&(opt=opt.type);opt=="map"?fn=serializeHash:opt=="array"?fn=reqwest.serializeArray:fn=serializeQueryString;return fn.apply(null,args)};reqwest.toQueryString=function(o){var qs="",i,enc=encodeURIComponent,push=function(k,v){qs+=enc(k)+"="+enc(v)+"&"};if(isArray(o))for(i=0;o&&i<o.length;i++)push(o[i].name,o[i].value);else for(var k in o){if(!Object.hasOwnProperty.call(o,k))continue;var v=o[k];if(isArray(v))for(i=0;i<v.length;i++)push(k,v[i]);else push(k,o[k])}return qs.replace(/&$/,"").replace(/%20/g,"+")};reqwest.compat=function(o,fn){if(o){o.type&&(o.method=o.type)&&delete o.type;o.dataType&&(o.type=o.dataType);o.jsonpCallback&&(o.jsonpCallbackName=o.jsonpCallback)&&delete o.jsonpCallback;o.jsonp&&(o.jsonpCallback=o.jsonp)}return new Reqwest(o,fn)};return reqwest});provide("reqwest",module.exports);!function($){var r=require("reqwest"),integrate=function(method){return function(){var args=Array.prototype.slice.call(arguments,0),i=this&&this.length||0;while(i--)args.unshift(this[i]);return r[method].apply(null,args)}},s=integrate("serialize"),sa=integrate("serializeArray");$.ender({ajax:r,serialize:r.serialize,serializeArray:r.serializeArray,toQueryString:r.toQueryString});$.ender({serialize:s,serializeArray:sa},!0)}(ender)})();(function(){var module={exports:{}},exports=module.exports;(function(){var $,Formwatcher,Watcher,inputSelector,__slice=[].slice,__hasProp={}.hasOwnProperty,__extends=function(child,parent){function ctor(){this.constructor=child}for(var key in parent)__hasProp.call(parent,key)&&(child[key]=parent[key]);ctor.prototype=parent.prototype;child.prototype=new ctor;child.__super__=parent.prototype;return child};$=ender;$.ender({fwData:function(name,value){var formwatcherAttributes;this.data("_formwatcher")==null&&this.data("_formwatcher",{});if(name==null)return this;formwatcherAttributes=this.data("_formwatcher");if(value!=null){formwatcherAttributes[name]=value;this.data("_formwatcher",formwatcherAttributes);return this}return formwatcherAttributes[name]}},!0);inputSelector="input, textarea, select, button";Formwatcher={version:"2.1.8",debugging:!1,debug:function(){if(this.debugging&&(typeof console!=="undefined"&&console!==null?console.debug:void 0)!=null)return console.debug.apply(console,arguments)},getErrorsElement:function(elements,createIfNotFound){var errors,input;input=elements.input;input.attr("name")&&(errors=$("#"+input.attr("name")+"-errors"));(errors!=null?errors.length:void 0)||!input.attr("id")||(errors=$("#"+input.attr("id")+"-errors"));if(!errors||!errors.length){errors=$.create("<span />");input.attr("name")&&errors.attr("id",input.attr("name")+"-errors");errors.insertAfter(input)}errors.hide().addClass("errors").addClass("fw-errors");return errors},deepExtend:function(){var extenders,key,object,other,val,_i,_len;object=arguments[0],extenders=2<=arguments.length?__slice.call(arguments,1):[];if(object==null)return{};for(_i=0,_len=extenders.length;_i<_len;_i++){other=extenders[_i];for(key in other){if(!__hasProp.call(other,key))continue;val=other[key];object[key]==null||typeof val!="object"?object[key]=val:object[key]=this.deepExtend(object[key],val)}}return object},getLabel:function(elements,automatchLabel){var input,label,parent;input=elements.input;if(input.attr("id")){label=$("label[for="+input.attr("id")+"]");label.length||(label=undefined)}if(!label&&automatchLabel){parent=input.parent();if(parent.get(0).nodeName==="LABEL"){label=$("span",parent).first();label.length===0&&(label=void 0)}else{label=input.previous();if(!label.length||label.get(0).nodeName!=="LABEL"||label.attr("for")!=null)label=void 0}}return label},changed:function(elements,watcher){var input;input=elements.input;if(!input.fwData("forceValidationOnChange")&&input.attr("type")==="checkbox"&&input.fwData("previouslyChecked")===!!input[0].checked||input.fwData("previousValue")===input.val())return;input.fwData("forceValidationOnChange",!1);this.setPreviousValueToCurrentValue(elements);input.attr("type")==="checkbox"&&input.fwData("initialyChecked")!==!!input[0].checked||input.attr("type")!=="checkbox"&&input.fwData("initialValue")!==input.val()?Formwatcher.setChanged(elements,watcher):Formwatcher.unsetChanged(elements,watcher);if(watcher.options.validate)return watcher.validateElements(elements)},setChanged:function(elements,watcher){var element,i,input;input=elements.input;if(input.fwData("changed"))return;for(i in elements){if(!__hasProp.call(elements,i))continue;element=elements[i];element.addClass("changed")}input.fwData("changed",!0);watcher.options.submitUnchanged||Formwatcher.restoreName(elements);if(watcher.options.submitOnChange&&watcher.options.ajax)return watcher.submitForm()},unsetChanged:function(elements,watcher){var element,i,input;input=elements.input;if(!input.fwData("changed"))return;for(i in elements){if(!__hasProp.call(elements,i))continue;element=elements[i];element.removeClass("changed")}input.fwData("changed",!1);if(!watcher.options.submitUnchanged)return Formwatcher.removeName(elements)},storeInitialValue:function(elements){var input;input=elements.input;input.attr("type")==="checkbox"?input.fwData("initialyChecked",!!input[0].checked):input.fwData("initialValue",input.val());return this.setPreviousValueToInitialValue(elements)},restoreInitialValue:function(elements){var input;input=elements.input;input.attr("type")==="checkbox"?input.attr("checked",input.fwData("initialyChecked")):input.val(input.fwData("initialValue"));return this.setPreviousValueToInitialValue(elements)},setPreviousValueToInitialValue:function(elements){var input;input=elements.input;return input.attr("type")==="checkbox"?input.fwData("previouslyChecked",input.fwData("initialyChecked")):input.fwData("previousValue",input.fwData("initialValue"))},setPreviousValueToCurrentValue:function(elements){var input;input=elements.input;return input.attr("type")==="checkbox"?input.fwData("previouslyChecked",!!input[0].checked):input.fwData("previousValue",input.val())},removeName:function(elements){var input;input=elements.input;if(input.attr("type")==="checkbox")return;input.fwData("name")||input.fwData("name",input.attr("name")||"");return input.attr("name","")},restoreName:function(elements){var input;input=elements.input;if(input.attr("type")==="checkbox")return;return input.attr("name",input.fwData("name"))},decorators:[],decorate:function(watcher,input){var dec,decorator,_i,_len,_ref;decorator=null;_ref=watcher.decorators;for(_i=0,_len=_ref.length;_i<_len;_i++){dec=_ref[_i];if(dec.accepts(input)){decorator=dec;break}}if(decorator){Formwatcher.debug('Decorator "'+decorator.name+'" found for input field "'+input.attr("name")+'".');return decorator.decorate(input)}return{input:input}},validators:[],currentWatcherId:0,watchers:[],add:function(watcher){return this.watchers[watcher.id]=watcher},get:function(id){return this.watchers[id]},getAll:function(){return this.watchers},scanDocument:function(){var formId,handleForm,_results,_this=this;handleForm=function(form){var domOptions,formId,options;form=$(form);if(form.fwData("watcher"))return;formId=form.attr("id");options=formId!=null&&Formwatcher.options[formId]!=null?Formwatcher.options[formId]:{};domOptions=form.data("fw");domOptions&&(options=_this.deepExtend(options,JSON.parse(domOptions)));return new Watcher(form,options)};$("form[data-fw]").each(function(form){return handleForm(form)});_results=[];for(formId in Formwatcher.options)_results.push(handleForm($("#"+formId)));return _results},watch:function(form,options){return $.domReady(function(){return new Watcher(form,options)})}};Formwatcher._ElementWatcher=function(){function _ElementWatcher(watcher){var _ref;this.watcher=watcher;this.options=Formwatcher.deepExtend({},this.defaultOptions,(_ref=watcher.options[this.name])!=null?_ref:{})}_ElementWatcher.prototype.name="No name";_ElementWatcher.prototype.description="No description";_ElementWatcher.prototype.nodeNames=null;_ElementWatcher.prototype.classNames=[];_ElementWatcher.prototype.defaultOptions={};_ElementWatcher.prototype.options=null;_ElementWatcher.prototype.accepts=function(input){var className,correctClassNames,correctNodeName,inputNodeName,nodeName,_i,_j,_len,_len1,_ref,_ref1;if(this.watcher.options[this.name]!=null&&this.watcher.options[this.name]===!1)return!1;correctNodeName=!1;inputNodeName=input.get(0).nodeName;_ref=this.nodeNames;for(_i=0,_len=_ref.length;_i<_len;_i++){nodeName=_ref[_i];if(inputNodeName===nodeName){correctNodeName=!0;break}}if(!correctNodeName)return!1;correctClassNames=!0;_ref1=this.classNames;for(_j=0,_len1=_ref1.length;_j<_len1;_j++){className=_ref1[_j];if(!input.hasClass(className)){correctClassNames=!1;break}}return correctClassNames};return _ElementWatcher}();Formwatcher.Decorator=function(_super){function Decorator(){return Decorator.__super__.constructor.apply(this,arguments)}__extends(Decorator,_super);Decorator.prototype.decorate=function(watcher,input){return{input:input}};return Decorator}(Formwatcher._ElementWatcher);Formwatcher.Validator=function(_super){function Validator(){return Validator.__super__.constructor.apply(this,arguments)}__extends(Validator,_super);Validator.prototype.nodeNames=["INPUT","TEXTAREA","SELECT"];Validator.prototype.validate=function(sanitizedValue,input){return!0};Validator.prototype.sanitize=function(value){return value};return Validator}(Formwatcher._ElementWatcher);Formwatcher.defaultOptions={ajax:!1,ajaxMethod:null,validate:!0,submitOnChange:!1,submitUnchanged:!0,submitFormIfAllUnchanged:!1,resetFormAfterSubmit:!1,automatchLabel:!0,responseCheck:function(data){return!data},onSubmit:function(){},onSuccess:function(data){},onError:function(data){return alert(data)},onComplete:function(data){}};Formwatcher.options={};Watcher=function(){function Watcher(form,options){var Decorator,Validator,hiddenSubmitButtonElement,submitButtons,_i,_j,_len,_len1,_ref,_ref1,_ref2,_this=this;this.form=typeof form=="string"?$("#"+form):$(form);if(this.form.length<1)throw"Form element not found.";if(this.form.length>1)throw"More than one form was found.";if(this.form.get(0).nodeName!=="FORM")throw"The element was not a form.";this.allElements=[];this.id=Formwatcher.currentWatcherId++;Formwatcher.add(this);this.observers={};this.form.fwData("watcher",this);this.form.fwData("originalAction",this.form.attr("action")||"").attr("action","javascript:undefined;");this.options=Formwatcher.deepExtend({},Formwatcher.defaultOptions,options||{});this.decorators=[];this.validators=[];_ref=Formwatcher.decorators;for(_i=0,_len=_ref.length;_i<_len;_i++){Decorator=_ref[_i];this.decorators.push(new Decorator(this))}_ref1=Formwatcher.validators;for(_j=0,_len1=_ref1.length;_j<_len1;_j++){Validator=_ref1[_j];this.validators.push(new Validator(this))}this.options.ajaxMethod===null&&(this.options.ajaxMethod=(_ref2=this.form.attr("method"))!=null?_ref2.toLowerCase():void 0);switch(this.options.ajaxMethod){case"post":case"put":case"delete":break;default:this.options.ajaxMethod="get"}this.observe("submit",this.options.onSubmit);this.observe("success",this.options.onSuccess);this.observe("error",this.options.onError);this.observe("complete",this.options.onComplete);$(inputSelector,this.form).each(function(input){var element,elements,errorsElement,i,label,onchangeFunction,validateElementsFunction,validator,_k,_len2,_ref3,_results;input=$(input);if(!input.fwData("initialized")){if(input.attr("type")==="hidden")return input.fwData("forceSubmission",!0);elements=Formwatcher.decorate(_this,input);if(elements.input.get()!==input.get()){elements.input.attr("class",input.attr("class"));input=elements.input}if(!elements.label){label=Formwatcher.getLabel(elements,_this.options.automatchLabel);label&&(elements.label=label)}if(!elements.errors){errorsElement=Formwatcher.getErrorsElement(elements,!0);elements.errors=errorsElement}_this.allElements.push(elements);input.fwData("validators",[]);_ref3=_this.validators;for(_k=0,_len2=_ref3.length;_k<_len2;_k++){validator=_ref3[_k];if(validator.accepts(input,_this)){Formwatcher.debug('Validator "'+validator.name+'" found for input field "'+input.attr("name")+'".');input.fwData("validators").push(validator)}}Formwatcher.storeInitialValue(elements);if(input.val()===null||!input.val())for(i in elements){element=elements[i];element.addClass("empty")}_this.options.submitUnchanged||Formwatcher.removeName(elements);onchangeFunction=function(){return Formwatcher.changed(elements,_this)};validateElementsFunction=function(){return _this.validateElements(elements,!0)};_results=[];for(i in elements){element=elements[i];_results.push(function(element){var _this=this;element.on("focus",function(){return element.addClass("focus")});element.on("blur",function(){return element.removeClass("focus")});element.on("change",onchangeFunction);element.on("blur",onchangeFunction);return element.on("keyup",validateElementsFunction)}(element))}return _results}});submitButtons=$("input[type=submit], button[type=''], button[type='submit'], button:not([type])",this.form);hiddenSubmitButtonElement=$.create('<input type="hidden" name="" value="" />');this.form.append(hiddenSubmitButtonElement);submitButtons.each(function(element){element=$(element);return element.click(function(e){var elementValue,tmpElementText,_ref3,_ref4;if(element[0].tagName==="BUTTON"){tmpElementText=element.text();element.text("");elementValue=(_ref3=element.val())!=null?_ref3:"";element.text(tmpElementText)}else elementValue=(_ref4=element.val())!=null?_ref4:"";hiddenSubmitButtonElement.attr("name",element.attr("name")||"").val(elementValue);_this.submitForm();return e.stopPropagation()})})}Watcher.prototype.callObservers=function(){var args,eventName,observer,_i,_len,_ref,_results;eventName=arguments[0],args=2<=arguments.length?__slice.call(arguments,1):[];_ref=this.observers[eventName];_results=[];for(_i=0,_len=_ref.length;_i<_len;_i++){observer=_ref[_i];_results.push(observer.apply(this,args))}return _results};Watcher.prototype.observe=function(eventName,func){this.observers[eventName]===undefined&&(this.observers[eventName]=[]);this.observers[eventName].push(func);return this};Watcher.prototype.stopObserving=function(eventName,func){var observer;this.observers[eventName]=function(){var _i,_len,_ref,_results;_ref=this.observers[eventName];_results=[];for(_i=0,_len=_ref.length;_i<_len;_i++){observer=_ref[_i];observer!==func&&_results.push(observer)}return _results}.call(this);return this};Watcher.prototype.enableForm=function(){return $(inputSelector,this.form).removeAttr("disabled")};Watcher.prototype.disableForm=function(){return $(inputSelector,this.form).attr("disabled","disabled")};Watcher.prototype.submitForm=function(e){var _this=this;if(!this.options.validate||this.validateForm()){this.callObservers("submit");this.form.addClass("submitting");if(this.options.ajax){this.disableForm();return this.submitAjax()}this.form.attr("action",this.form.fwData("originalAction"));setTimeout(function(){_this.form.submit();return _this.disableForm()},1);return!1}};Watcher.prototype.validateForm=function(){var elements,validated,_i,_len,_ref;validated=!0;_ref=this.allElements;for(_i=0,_len=_ref.length;_i<_len;_i++){elements=_ref[_i];this.validateElements(elements)||(validated=!1)}return validated};Watcher.prototype.validateElements=function(elements,inlineValidating){var element,i,input,sanitizedValue,validated,validationOutput,validator,_i,_j,_len,_len1,_ref,_ref1;input=elements.input;validated=!0;if(input.fwData("validators").length){if(!inlineValidating||!input.fwData("lastValidatedValue")||input.fwData("lastValidatedValue")!==input.val()){input.fwData("lastValidatedValue",input.val());Formwatcher.debug("Validating input "+input.attr("name"));input.fwData("validationErrors",[]);_ref=input.fwData("validators");for(_i=0,_len=_ref.length;_i<_len;_i++){validator=_ref[_i];if(input.val()===""&&validator.name!=="Required"){Formwatcher.debug("Validating "+validator.name+". Field was empty so continuing.");continue}Formwatcher.debug("Validating "+validator.name);validationOutput=validator.validate(validator.sanitize(input.val()),input);if(validationOutput!==!0){validated=!1;input.fwData("validationErrors").push(validationOutput);break}}if(validated){elements.errors.html("").hide();for(i in elements){if(!__hasProp.call(elements,i))continue;element=elements[i];element.addClass("validated");element.removeClass("error")}inlineValidating&&elements.input.fwData("forceValidationOnChange",!0)}else{for(i in elements){if(!__hasProp.call(elements,i))continue;element=elements[i];element.removeClass("validated")}if(!inlineValidating){elements.errors.html(input.fwData("validationErrors").join("<br />")).show();for(i in elements){if(!__hasProp.call(elements,i))continue;element=elements[i];element.addClass("error")}}}}if(!inlineValidating&&validated){sanitizedValue=input.fwData("lastValidatedValue");_ref1=input.fwData("validators");for(_j=0,_len1=_ref1.length;_j<_len1;_j++){validator=_ref1[_j];sanitizedValue=validator.sanitize(sanitizedValue)}input.val(sanitizedValue)}}else for(i in elements){if(!__hasProp.call(elements,i))continue;element=elements[i];element.addClass("validated")}return validated};Watcher.prototype.submitAjax=function(){var fieldCount,fields,i,_this=this;Formwatcher.debug("Submitting form via AJAX.");fields={};fieldCount=0;i=0;$(inputSelector,this.form).each(function(input,i){var attributeName,_ref;input=$(input);if(input[0].nodeName==="BUTTON"||input[0].nodeName==="INPUT"&&(input.attr("type").toLowerCase()==="submit"||input.attr("type").toLowerCase()==="button"))return;if(input.fwData("forceSubmission")||input.attr("type")==="checkbox"||input.fwData("changed")||_this.options.submitUnchanged)if(input.attr("type")!=="checkbox"||input.get(0).checked){fieldCount++;attributeName=(_ref=input.attr("name"))!=null?_ref:"unnamedInput_"+i;return fields[attributeName]=input.val()}});return fieldCount===0&&!this.options.submitFormIfAllUnchanged?setTimeout(function(){_this.enableForm();return _this.ajaxSuccess()},1):$.ajax({url:this.form.fwData("originalAction"),method:this.options.ajaxMethod,data:fields,type:"text",error:function(request){return _this.callObservers("error",request.response)},success:function(request){_this.enableForm();if(!_this.options.responseCheck(request.response))return _this.callObservers("error",request.response);_this.callObservers("success",request.response);return _this.ajaxSuccess()},complete:function(request){_this.form.removeClass("submitting");return _this.callObservers("complete",request.response)}})};Watcher.prototype.ajaxSuccess=function(){var element,elements,i,isEmpty,_i,_len,_ref,_results;_ref=this.allElements;_results=[];for(_i=0,_len=_ref.length;_i<_len;_i++){elements=_ref[_i];Formwatcher.unsetChanged(elements,this);this.options.resetFormAfterSubmit?Formwatcher.restoreInitialValue(elements):Formwatcher.storeInitialValue(elements);isEmpty=elements.input.val()===null||!elements.input.val();_results.push(function(){var _results1;_results1=[];for(i in elements){element=elements[i];isEmpty?_results1.push(element.addClass("empty")):_results1.push(element.removeClass("empty"))}return _results1}())}return _results};return Watcher}();if(typeof window!="undefined"&&window!==null){window.Formwatcher=Formwatcher;window.Watcher=Watcher}$.domReady(function(){return Formwatcher.scanDocument()})}).call(this);(function(){var trim,__hasProp={}.hasOwnProperty,__extends=function(child,parent){function ctor(){this.constructor=child}for(var key in parent)__hasProp.call(parent,key)&&(child[key]=parent[key]);ctor.prototype=parent.prototype;child.prototype=new ctor;child.__super__=parent.prototype;return child};trim=function(string){return string.replace(/^\s.*\s$/,"")};Formwatcher.validators.push(function(_super){function _Class(){return _Class.__super__.constructor.apply(this,arguments)}__extends(_Class,_super);_Class.prototype.name="Integer";_Class.prototype.description="Makes sure a value is an integer";_Class.prototype.classNames=["validate-integer"];_Class.prototype.validate=function(value){return value.replace(/\d*/,"")!==""?"Has to be a number.":!0};_Class.prototype.sanitize=function(value){return trim(value)};return _Class}(Formwatcher.Validator));Formwatcher.validators.push(function(_super){function _Class(){return _Class.__super__.constructor.apply(this,arguments)}__extends(_Class,_super);_Class.prototype.name="Required";_Class.prototype.description="Makes sure the value is not blank (nothing or spaces).";_Class.prototype.classNames=["required"];_Class.prototype.validate=function(value,input){return input.attr("type")==="checkbox"&&!input.is(":checked")||!trim(value)?"Can not be blank.":!0};return _Class}(Formwatcher.Validator));Formwatcher.validators.push(function(_super){function _Class(){return _Class.__super__.constructor.apply(this,arguments)}__extends(_Class,_super);_Class.prototype.name="NotZero";_Class.prototype.description="Makes sure the value is not 0.";_Class.prototype.classNames=["not-zero"];_Class.prototype.validate=function(value){var intValue;intValue=parseInt(value);return!isNaN(intValue)&&intValue===0?"Can not be 0.":!0};return _Class}(Formwatcher.Validator));Formwatcher.validators.push(function(_super){function _Class(){return _Class.__super__.constructor.apply(this,arguments)}__extends(_Class,_super);_Class.prototype.name="Email";_Class.prototype.description="Makes sure the value is an email.";_Class.prototype.classNames=["validate-email"];_Class.prototype.validate=function(value){var emailRegEx;emailRegEx=/^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;return value.match(emailRegEx)?!0:"Must be a valid email address."};_Class.prototype.sanitize=function(value){return trim(value)};return _Class}(Formwatcher.Validator));Formwatcher.validators.push(function(_super){function _Class(){return _Class.__super__.constructor.apply(this,arguments)}__extends(_Class,_super);_Class.prototype.name="Float";_Class.prototype.description="Makes sure a value is a float";_Class.prototype.classNames=["validate-float"];_Class.prototype.defaultOptions={decimalMark:","};_Class.prototype.validate=function(value){var regex;regex=new RegExp("\\d+(\\"+this.options.decimalMark+"\\d+)?");return value.replace(regex,"")!==""?"Has to be a number.":!0};_Class.prototype.sanitize=function(value){value.indexOf(".")>=0&&value.indexOf(",")>=0&&(value.lastIndexOf(",")>value.lastIndexOf(".")?value=value.replace(/\./g,""):value=value.replace(/\,/g,""));value.indexOf(",")>=0&&(value=value.replace(/\,/g,"."));value.indexOf(".")!==value.lastIndexOf(".")&&(value=value.replace(/\./g,""));value=value.replace(/\./g,this.options.decimalMark);return trim(value)};return _Class}(Formwatcher.Validator))}).call(this);provide("formwatcher",module.exports)})()